                ...
                , Http.post
                    ...
                    , body =
                        Http.multipartBody
                            ...
                            ,stringPart "puzzle-two" (Encode.encode 1 (Encode.object [("testName1",Encode.string model.testCases1.testName)
                                              ,("validator1",Encode.string model.testCases1.validator)
                                              ]))
                            ,stringPart "puzzle-three" (Encode.encode 1 (Encode.object [("input",Encode.string model.testCases1.test.input)
